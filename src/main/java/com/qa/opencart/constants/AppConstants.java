...
public class AppConstants {
	...
	public static final String LOGO_URL_PATH = "https://naveenautomationlabs.com/opencart/image/catalog/opencart-logo.png";
	...
	public static final List<String> EXPECTED_ACCOUNTS_PAGE_HEADERS_VALUE = Arrays.asList("My Account", "My Orders",
